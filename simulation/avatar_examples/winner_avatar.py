...
class Avatar(object):
    ...
    def get_closest_score_location(self):
        return min(self.world_state.map_centred_at_me.get_score_cells(), key=lambda cell: self.distance_between(cell.location, self.world_state.my_avatar.location)).location
